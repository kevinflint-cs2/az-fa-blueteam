...
def goodbye(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Python HTTP trigger function processed a request for goodbye.')
    ...
    if name:
        ...
        return func.HttpResponse(
            "Goodbye. Pass a name in the query string or in the request body for a personalized response.",
            status_code=200
        )